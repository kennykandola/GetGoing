class NotificationDecorator < ApplicationDecorator
  ...
  def render_activity
    ...
    when 'new_response'
      ...
      h.render partial: 'users/activities/activity_uao', locals: { activity: self, action: action }
    ...
    when 'new_post_with_matching_place'
      ...
      h.render partial: 'users/activities/activity_uaoe', locals: { activity: self, action: action, extra: extra }
    ...
    when 'claims_open'
      action = 'has opened'
      extra = 'Claim for '
      h.render partial: 'users/activities/activity_eoa', locals: { activity: self, action: action, extra: extra }
    when 'claim_expired'
      action = 'has expired'
